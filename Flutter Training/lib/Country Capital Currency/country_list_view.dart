...
import 'package:tt/Country%20Capital%20Currency/country_details.dart';
...
class _CountryListViewState extends State<CountryListView> {
  ...
  Widget LoadImage(String address){
    if(address.contains('https')) {
      ...
      if(true){
        ...
        return Image.asset('images/no_image.png', fit: BoxFit.fill,
                  // width: 200, height: 200,
        );
      }
    }
  ...
  ///This function checks the internet connectivity of the device.
